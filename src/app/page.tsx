...
export default function Home() {
  return (
    <main className="flex flex-col items-center w-full gap-2">
      {/* Main Menu */}
      <section className="sticky top-0 flex items-center justify-between w-full gap-4 px-8 py-4 border-b bg-background/70 backdrop-blur-2xl">
        <FinaApp />
        <p className="text-sm text-muted-foreground">Your personal finance app with <span className="font-semibold text-chart-2">AI Powered</span></p>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-1 w-fit text-primary font-medium bg-primary/5 border-primary px-3 py-1.5 border rounded-lg text-sm">
              ...
              <p className='text-xs'>AI Powered Finance Manager</p>
            </div>
            <h1 className="-mt-3 text-4xl font-bold">Manage Your Money <br />
              <span className="text-primary">Smarter</span> with
              <span className="text-chart-2"> AI</span>
            </h1>
            <p className="-mt-2 text-sm tracking-wide text-muted-foreground ">Fina App is my portofolio project that helps you track expenses, set budgets,
              and get AI-powered insights using Gemini API. Experience the future of personal finance with Generative UI.</p>
            <Button
              size="default"
              className="w-fit text-xs h-10! px-4 mt-2 mb-4"
              asChild
            >
              <Link href="/dashboard">
                Explore Dashboard
            ...
            <div className="grid grid-cols-1 gap-2 lg:grid-cols-3">
              <div className='flex flex-col items-center p-3 space-y-2 text-sm border rounded-sm lg:items-start border-border'>
          ...
          <div className="border border-border rounded-xl">
            <Image src="/img_dashboard.png" width={1000} height={1000} loading="eager" alt="Dashboard"
              className="rounded-xl"
            />
          </div>
          <div className="flex flex-col items-center justify-center w-full col-span-2 gap-3">
            ...
            <div className="flex flex-col items-center gap-2 md:flex-row">
              <div className="flex items-center justify-center gap-2 px-4 py-2 text-xs font-medium bg-white border rounded-md w-36 text-slate-900 dark:bg-white/80 border-border">
      ...
      <div className="flex flex-col items-center justify-center gap-0">
        ...
        <p className="text-sm not-italic text-muted-foreground">Your personal finance app with <span className="italic font-semibold text-chart-2">AI Powered</span></p>
      </div>
